...
export const Contact = (): JSX.Element => {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-clip bg-white">
      <SiteHeader />
      <main>
        <section className="mx-auto grid w-full max-w-[1440px] gap-10 px-4 py-10 md:px-[29px] min-[1400px]:grid-cols-[560px_minmax(0,1fr)] min-[1400px]:gap-[86px] min-[1400px]:pb-[67px] min-[1400px]:pt-[40px]">
          <div>
